...
#### Case 1: 1368x2189, RGB_ALPHA, 8bpc (SUB filter only)
...
#### Case 2: 1920x1080, RGB_ALPHA, 8bpc (Mixed filters, mostly PAETH)
| Decoder | Mode | Cnt | Score (ops/s) | Error |
| :--- | :--- | :--- | :--- | :--- |
...
#### Case 3: 1054x1492, RGB, 8bpc (Mixed filters, mostly PAETH)
| Decoder | Mode | Cnt | Score (ops/s) | Error |
| :--- | :--- | :--- | :--- | :--- |
...
#### Case 4: 1920x1080, RGB, 16bpc (PAETH filter only)
| Decoder | Mode | Cnt | Score (ops/s) | Error |
| :--- | :--- | :--- | :--- | :--- |

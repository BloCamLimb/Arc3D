...
package icyllis.arc3d.compiler.test;
...
public class CompilerBenchmark {
    ...
    // varies with source length, shaderc is a wrapper of glslang
    //Benchmark                   Mode  Cnt     Score     Error  Units
    //CompilerBenchmark.arc3d    thrpt   10  1722.465 ± 168.368  ops/s
    //CompilerBenchmark.shaderc  thrpt   10   121.065 ±  82.475  ops/s
    ...
    public static void shaderc(Blackhole blackhole) {
        ...
        long result = shaderc_compile_into_spv(compiler, SOURCE_BUFFER, shaderc_fragment_shader,
    ...
    public static void arc3d(Blackhole blackhole) {
        ...
        ShaderCaps caps = new ShaderCaps();
        caps.mTargetApi = TargetApi.OPENGL_4_5;
        caps.mSPIRVVersion = SPIRVVersion.SPIRV_1_0;
        CompileOptions options = new CompileOptions();
        options.mOptimizationLevel = 0;
        ByteBuffer spirv = compiler.compileIntoSPIRV(SOURCE_AKSL, ShaderKind.FRAGMENT,
                caps, options, COMMON_MODULE);
        blackhole.consume(Objects.requireNonNull(spirv));
        // auto-GC
    }
}

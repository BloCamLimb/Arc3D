...
public final class ImmediateContext extends Context {
    ...
    public void setSharedObject(@NonNull String key, @NonNull Object value) {
        assert isOwnerThread();
        Objects.requireNonNull(key);
        var old = mDevice.mSharedObjects.putIfAbsent(key, Objects.requireNonNull(value));
        if (old != null) {
            throw new IllegalStateException("key " + key + " already associated with value " + old);
        }
    }

...
public class UniformHandler {
     ...
     */
    public ShaderVar getUniformVariable(@UniformDataManager.UniformHandle int handle) {
     ...
     * @param handle UniformHandle from Effect Block
     */
    public final String getUniformName(@UniformDataManager.UniformHandle int handle) {
